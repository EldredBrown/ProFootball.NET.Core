...
namespace EldredBrown.ProFootball.AspNetCore.MvcWebApp.Tests.ControllerTests
{
    public class ConferenceControllerTest
    {
        ...
        //    fakeConferenceIndexViewModel.Conferences.ShouldBe(conferences);
        ...
        //    fakeConferenceDetailsViewModel.Conference.ShouldBe(conference);
        //    result.ShouldBeOfType<ViewResult>();
        ...
        //        innerException: new Exception("The INSERT statement conflicted with the FOREIGN KEY constraint \"FK_Conference_League_LeagueName\".")
        //    );
        ...
        //    testController.ModelState.IsValid.ShouldBeFalse();
        //    testController.ModelState.ErrorCount.ShouldBe(1);
        //    testController.ModelState.ShouldContainKey("LastSeasonId");
        //    testController.ModelState["LastSeasonId"].Errors[0].ErrorMessage
        ...
        //    var ex = new DbUpdateException(
        //        message: "DbUpdateException",
        //        innerException: new Exception("The UPDATE statement conflicted with the FOREIGN KEY constraint \"FK_Conference_League_LeagueName\".")
        //    );
        //    A.CallTo(() => fakeSharedRepository.SaveChangesAsync()).Throws(ex);
        ...
        //    // Act
        //    int id = 2;
        //    var conference = new Conference { Id = 2 };
        //    var result = await testController.Edit(id, conference);
