...
namespace EldredBrown.ProFootball.AspNetCore.MvcWebApp.Tests.ViewModelTests
{
    public class LeagueViewModelMapperTests
    {
        ...
        [Fact]
        public async Task MapViewModelToLeague_WhenLastSeasonYearIsNull_ShouldSucceed()
        {
            // Arrange
        ...
        [Fact]
        public async Task MapViewModelToLeague_WhenLastSeasonYearIsNotNull_ShouldSucceed()
        {
            // Arrange
            var leagueViewModel = new LeagueViewModel
            {
