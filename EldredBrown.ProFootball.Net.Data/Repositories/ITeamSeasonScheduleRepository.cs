...
namespace EldredBrown.ProFootball.Net.Data.Repositories
{
    public interface ITeamSeasonScheduleRepository
    {
        ...
        IEnumerable<TeamSeasonOpponentProfile> GetTeamSeasonScheduleProfile(int teamId, int seasonYear);
        ...
        /// </param>
        /// <returns>The fetched <see cref="IEnumerable{OpponentProfile}"/> collection.</returns>
        Task<IEnumerable<TeamSeasonOpponentProfile>> GetTeamSeasonScheduleProfileAsync(int teamId, int seasonYear);
        ...
        TeamSeasonScheduleTotals GetTeamSeasonScheduleTotals(int teamId, int seasonYear);
        ...
        /// </param>
        /// <returns>The fetched <see cref="TeamSeasonScheduleTotals"/> entity.</returns>
        Task<TeamSeasonScheduleTotals> GetTeamSeasonScheduleTotalsAsync(int teamId, int seasonYear);
        ...
        TeamSeasonScheduleAverages GetTeamSeasonScheduleAverages(int teamId, int seasonYear);
        ...
        /// </param>
        /// <returns>The fetched <see cref="TeamSeasonScheduleAverages"/> entity.</returns>
        Task<TeamSeasonScheduleAverages> GetTeamSeasonScheduleAveragesAsync(int teamId, int seasonYear);
    }
}
