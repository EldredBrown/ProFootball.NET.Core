...
namespace EldredBrown.ProFootball.AspNetCore.MvcWebApp.ViewModels.TeamSeason
{
    ...
    public class TeamSeasonViewModelMapper(
        ITeamRepository teamRepository, ISeasonRepository seasonRepository, IAssociationRepository associationRepository
    ) : ITeamSeasonViewModelMapper
    {
        ...
        )
        {
            ...
            teamSeason.SeasonYear = season is not null ? season.Year : -1;

            var league = await associationRepository.GetAssociationByShortNameAsync(teamSeasonViewModel.LeagueName);
